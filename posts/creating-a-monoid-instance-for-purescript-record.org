...
This of-course doesn't really work on nested records, where I probably need to wrap then in ~newtype~, but even then, the implementation would have been simpler.
